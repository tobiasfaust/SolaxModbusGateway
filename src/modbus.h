...
class modbus {
  ...
  private:
    ...
    regfiles_t           	    state_Relay1;          // Pin zum Abfragen des ersten Potetialfreien Kontakts
    const String&           	    state_Relay2;          // Pin zum Abfragen des ersten Potetialfreien Kontakts
