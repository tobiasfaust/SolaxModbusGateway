...
/*******************************************************
 * get size of available Live Data
*******************************************************/
size_t modbus::GetInverterLiveDataSize() {
  return this->InverterLiveData->size();
}

/*******************************************************
 * get Live register Data from the list
*******************************************************/
reg_t modbus::GetInverterLiveData(size_t i) {
  return this->InverterLiveData->at(i);
}
...
/*******************************************************
 * Return all RegisterData as jsonArray
 * {data: [{"name": "xx", "value": "xx"}], }
